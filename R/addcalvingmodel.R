...
addcalvingmodel <- function(RFID, mtag, date, hour, period, hour.mean.MI, hour.mean.diff.Z, hour.max.diff.Z, hour.max.MV, self.hour.min.diff.all,
                            ...
                            status, username = user, password = pass){
  ...
  calvmoddata <- sprintf(
    ...
    hour.rain, hour.humidity, hour.THI, day.minrain, day.rangerain, day.maxhumidity, day.meanhumidity, day.minTHI, day.meanTHI, day.sdTHI, status)
