...
getmlresults <- function(hour, username = user, password = pass){
  ...
  results <- mongo(collection = "AnitaMLResults", db = "PLMResearch", url = pass, verbose = T)
