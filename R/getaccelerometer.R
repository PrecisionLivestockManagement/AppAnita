...
#' @param time a list of timestamps
...
getaccelerometer <- function(time = NULL, username = user, password = pass){
  ...
  cattle <- mongo(collection = "AnitaAccelerometer", db = "PLMResearch", url = url, verbose = T)
